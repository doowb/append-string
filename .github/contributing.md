# Contributing to append-string

First and foremost, thank you! We appreciate that you want to contribute to append-string, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for append-string**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for append-string:

- star the [project](https://github.com/doowb/append-string)
- tweet your support for append-string
...
- **version**: please note the version of append-string are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of append-string may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/append-string
